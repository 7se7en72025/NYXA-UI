...
const circleStyle = {
  ...
  borderRadius: "50%",
  background:
    "radial-gradient(circle, rgba(154,240,244,0.15) 0%, rgba(154,240,244,0.02) 70%, transparent 100%)",
  ...
  return (
    <div className={s.wrapper}>
      <div
        ...
        style={show ? visibleAnimStyle : hiddenAnimStyle}
      >
        <h1 className={s.title}>
          <ScrambleText as="span" text="COMPONENTS 4 U" />
        </h1>
        <div className={s.eventsWrapper}>
          ...
          <div className={s.info}>
            <h2 key={current.name}>
              <ScrambleText as="span" text={current.name} />
            </h2>
            <span>
              <ScrambleText as="span" text={current.category} />
            </span>
          </div>
        </div>
      </div>
